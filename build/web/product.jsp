<%-- 
    Document   : product
    Created on : Feb 24, 2022, 11:28:28 AM
    Author     : Laptop88
--%>
                                ...
                                <div class="category_block" style="background-color: white">
                                    ...
                                    <c:forEach items="${listcategory}" var="s" varStatus="loop">
                                        <li class="">
                                            ...
                                            <span class="badge bg-warning text-white ms-1 rounded-pill">${s.size}</span>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-flex justify-content-center">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                <tag:TagHandler totalrecords="${newproduct.size()}" url="ProductServlet" pageindex="${index}" item=""></tag:TagHandler>
                                </ul>
                            </nav>
                        </div>
                    </div>
